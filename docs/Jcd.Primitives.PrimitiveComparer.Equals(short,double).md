...
## PrimitiveComparer.Equals(short, double) Method

Checks a Int16 and a Double for equality

```csharp
public static bool Equals(short x, double y);
```
#### Parameters

<a name='Jcd.Primitives.PrimitiveComparer.Equals(short,double).x'></a>

`x` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(short,double).y'></a>
