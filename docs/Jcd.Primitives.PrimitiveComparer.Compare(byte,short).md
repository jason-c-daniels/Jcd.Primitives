...
## PrimitiveComparer.Compare(byte, short) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,short).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,short).y'></a>
