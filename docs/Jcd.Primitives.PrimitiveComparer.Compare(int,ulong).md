...
## PrimitiveComparer.Compare(int, ulong) Method

Compares a Int32 to a UInt64

```csharp
public static int Compare(int x, ulong y);
```
#### Parameters

<a name='Jcd.Primitives.PrimitiveComparer.Compare(int,ulong).x'></a>

`x` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(int,ulong).y'></a>
