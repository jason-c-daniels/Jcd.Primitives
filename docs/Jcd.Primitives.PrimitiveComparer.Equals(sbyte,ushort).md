...
## PrimitiveComparer.Equals(sbyte, ushort) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Equals(sbyte,ushort).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(sbyte,ushort).y'></a>
