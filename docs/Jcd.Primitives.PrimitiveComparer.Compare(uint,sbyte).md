...
## PrimitiveComparer.Compare(uint, sbyte) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(uint,sbyte).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(uint,sbyte).y'></a>
