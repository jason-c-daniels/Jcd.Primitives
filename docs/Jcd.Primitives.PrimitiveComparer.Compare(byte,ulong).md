...
## PrimitiveComparer.Compare(byte, ulong) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,ulong).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,ulong).y'></a>
