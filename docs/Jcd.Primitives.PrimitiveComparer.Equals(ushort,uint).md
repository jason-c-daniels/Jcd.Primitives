...
## PrimitiveComparer.Equals(ushort, uint) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Equals(ushort,uint).x'></a>

`x` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(ushort,uint).y'></a>
