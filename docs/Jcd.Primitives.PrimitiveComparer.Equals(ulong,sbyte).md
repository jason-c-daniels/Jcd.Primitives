...
## PrimitiveComparer.Equals(ulong, sbyte) Method

Checks a UInt64 and a SByte for equality

```csharp
public static bool Equals(ulong x, sbyte y);
```
#### Parameters

<a name='Jcd.Primitives.PrimitiveComparer.Equals(ulong,sbyte).x'></a>

`x` [System.UInt64](https://docs.microsoft.com/en-us/dotnet/api/System.UInt64 'System.UInt64')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(ulong,sbyte).y'></a>
