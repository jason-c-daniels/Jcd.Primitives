...
## PrimitiveComparer.Compare(long, ulong) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(long,ulong).x'></a>

`x` [System.Int64](https://docs.microsoft.com/en-us/dotnet/api/System.Int64 'System.Int64')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(long,ulong).y'></a>
