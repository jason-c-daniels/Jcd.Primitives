...
## PrimitiveComparer.Compare(uint, short) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(uint,short).x'></a>

`x` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(uint,short).y'></a>
