...
## PrimitiveComparer.Compare(ulong, uint) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(ulong,uint).x'></a>

`x` [System.UInt64](https://docs.microsoft.com/en-us/dotnet/api/System.UInt64 'System.UInt64')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(ulong,uint).y'></a>
