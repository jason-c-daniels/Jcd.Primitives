...
## PrimitiveComparer.Compare(byte, long) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,long).x'></a>

`x` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(byte,long).y'></a>
