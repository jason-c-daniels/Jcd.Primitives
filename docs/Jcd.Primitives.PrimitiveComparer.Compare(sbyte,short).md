...
## PrimitiveComparer.Compare(sbyte, short) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(sbyte,short).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(sbyte,short).y'></a>
