...
## PrimitiveComparer.Equals(sbyte, byte) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Equals(sbyte,byte).x'></a>

`x` [System.SByte](https://docs.microsoft.com/en-us/dotnet/api/System.SByte 'System.SByte')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(sbyte,byte).y'></a>
