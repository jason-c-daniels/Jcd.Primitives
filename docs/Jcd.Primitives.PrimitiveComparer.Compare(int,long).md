...
## PrimitiveComparer.Compare(int, long) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(int,long).x'></a>

`x` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(int,long).y'></a>
