...
## PrimitiveComparer.Equals(float, double) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Equals(float,double).x'></a>

`x` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Equals(float,double).y'></a>
