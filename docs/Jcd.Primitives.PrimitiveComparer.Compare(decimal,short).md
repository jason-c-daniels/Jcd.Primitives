...
## PrimitiveComparer.Compare(decimal, short) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(decimal,short).x'></a>

`x` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(decimal,short).y'></a>
