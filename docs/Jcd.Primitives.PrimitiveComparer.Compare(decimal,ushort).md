...
## PrimitiveComparer.Compare(decimal, ushort) Method
...
<a name='Jcd.Primitives.PrimitiveComparer.Compare(decimal,ushort).x'></a>

`x` [System.Decimal](https://docs.microsoft.com/en-us/dotnet/api/System.Decimal 'System.Decimal')

The first item to compare

<a name='Jcd.Primitives.PrimitiveComparer.Compare(decimal,ushort).y'></a>
